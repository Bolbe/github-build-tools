...
#LINUX_BIN_FILE="MyApp" -> This is the name of the binary file generated by the build process. It should match the name of the executable created in the build directory. TARGET= in the .pro qt file.
#LINUX_APP_IMAGE="myapp"
...
if [ $# -ne 2 ]; then
    ...
    echo "This will build the application and create an AppImage named myapp.AppImage containing the binary MyApp."
    exit 1
fi
